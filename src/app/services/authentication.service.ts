...
export class AuthenticationService {
  ...
  loginUser(email: string, password: string): any {
    return this.commonService.fireAuth.signInWithEmailAndPassword(
      email,
      password
    );
  }
  ...
  signupUser(account: Account): any {
    return this.commonService.fireAuth
      .createUserWithEmailAndPassword(account.email, account.password)
      .then(() => {
        this.commonService.fireAuth.currentUser
          .updateProfile({
  ...
  updateUser(account: Account): any {
    return this.commonService.fireAuth.currentUser
      .updateProfile({
        displayName: account.name
      })
      .then(user => {
   ...
   */
  logoutUser(): any {
    return this.commonService.userProfile
      .child(this.commonService.currentUser.uid)
      .update({
  ...
  googleLogin(): any {
    return this.commonService.fireAuth.signInWithRedirect(
      this.commonService.googleAuth
    );
  }
}
